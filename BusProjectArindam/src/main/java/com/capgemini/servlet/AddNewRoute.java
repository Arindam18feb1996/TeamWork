...
import com.capgemini.service.IRouteAddService;
import com.capgemini.service.RouteAddServiceImpl;

@WebServlet("/AddNewRoute")
public class AddNewRoute extends HttpServlet {
	private static final long serialVersionUID = 1L;
	private IRouteAddService loginService=new RouteAddServiceImpl();
	...
	if(loginService.addRoute(routeBean)!= null) {
		response.sendRedirect("pages/AddNewRouteSuccess.html");
	}else {
